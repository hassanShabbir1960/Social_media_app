...
class SearchResultsComponent extends Component {
  async componentDidMount() {
    await this.setState({
      ...
      value: this.props.location.state.searchValue,
    });
  ...
  onSubmit = (e) => {
    ...
    this.setState({
      type: "Search",
      value: this.state.params.searchValue,
    });
    this.fetch();
  };
      ...
      <div>
        ...
        <div className="mt-5">
          ...
          <div className="mb-5 pl-sm-5 d-flex justify-content-center justify-content-sm-start align-items-center">
            <div className="h3 font-weight-bold">{this.state.type}:</div>
            <div className="h3 ml-2 text-pink">{this.state.value}</div>
          </div>
